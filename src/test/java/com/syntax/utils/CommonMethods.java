...
public class CommonMethods extends BaseClass {
	...
	/**
	 * This method will LogIn into WebSite
	 * 
	 * @author tetianahatley
	 * @param WebElement elementUsNm, WebElement elementPwd, WebElement elementClick, String uname, String pwd
	 * 
	 */

	public static void login(WebElement elementUsNm, WebElement elementPwd, WebElement elementClick, String uname,
			String pwd) {
		sendText(elementUsNm, uname);
		sendText(elementPwd, pwd);
		elementUsNm.click();
	}
...
//				System.out.println(value);
	...
	// **********************************************************
	/**
	 * Method that selects out of List //1 identify list //2 get all children with
	 * li tags //loop through each li tag and get text //if text is matching then we
	 * click //break
	 * 
